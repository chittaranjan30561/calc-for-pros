...
function CalC(){
    ...
    const addSymbolsToInput = (event:any) => {
        ...
        // let inputValue = document.getElementById('query') instanceof HTMLInputElement?
    ...
    const buttons = lst.map(i => <button id={i.toString()} onClick={addSymbolsToInput} >{i}</button>);
